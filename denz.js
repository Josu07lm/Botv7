...
memberLimit = 10
ban = []
premium = ["593992390339@s.whatsapp.net","593963930720@s.whatsapp.net"]
...
Usa ${prefix}daftar para verificarte y poder usar el bot`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const DnsBot = ["593992390339@s.whatsapp.net"] // esto lo puedes cambiar brou
			...
			mess = {
				...
				only: {
					...
					ownerB: '*Solo puede ser utilizado por Josue* ',
			...
			const ownerNumber = ["593992390339@s.whatsapp.net","593963930720@s.whataapp.net"] // tu numero 
...
case 'husbu':
		...
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/pato.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        }
